<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;width:600px;padding:0;border-collapse:collapse">
    <tr>
        ...
        <td style="width:390px;height:180px" class="cell cell_3" width="390" height="390"@if(isset($cell_3_bgcolor)) bgcolor="{{$cell_3_bgcolor}}" @endif>@if(isset($cell_3_url))<a href="{{$cell_3_url}}" target="_blank">@endif @if(isset($cell_3)){!! checkType($cell_3) !!}@endif @if(isset($cell_3_url))</a>@endif</td>
    </tr>
</table>
<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;width:600px;padding:0;border-collapse:collapse">
    <tr>
